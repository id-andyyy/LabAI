...
PAGE_MARGIN = Cm(2)
# Макс. ширина изображения = ширина текста минус красная строка: 17 - 1.25 = 15.75 см
MAX_IMAGE_WIDTH = Cm(15.75)
...
def _calc_image_width(image_path):
    ...
    # Макс. ширина = ширина текста минус красная строка = 17 - 1.25 = 15.75 см
    if width_cm > 15.75:
        width_cm = 15.75
    return width_cm
